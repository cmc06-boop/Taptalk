...
abstract final class ContentLocalization {
  static const Map<String, String> _categoryFil = {
    ...
    'food': 'Pagkain',
    'food_fruits': 'Prutas',
    'food_vegetables': 'Gulay',
    'food_dessert': 'Panghimagas',
    'food_meals': 'Pagkain',
    'drinks': 'Inumin',
    'drinks_hot': 'Mainit na Inumin',
    'drinks_cold': 'Malamig na Inumin',
    'drinks_dairy': 'Gatas at Yogurt',
    'activities': 'Mga Gawain',
    'alphabets': 'Alpabeto',
    'animals': 'Mga Hayop',
    'body_parts': 'Mga Bahagi ng Katawan',
    'dates': 'Mga Petsa',
    'dates_days': 'Mga Araw',
    'dates_months': 'Mga Buwan',
    'home': 'Bahay',
    'needs': 'Mga Kailangan',
    'numbers': 'Mga Numero',
    'phrases': 'Mga Parirala',
    'greetings': 'Pagbati',
    'school': 'Paaralan',
    'places': 'Mga Lugar',
  };
