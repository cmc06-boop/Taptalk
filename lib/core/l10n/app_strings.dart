...
abstract final class AppStrings {
  ...
  static String profileCodeHint(AppLanguage lang) =>
      lang == AppLanguage.filipino
      ? 'Ibahagi ang code na ito sa iyong magulang para ma-link ang account mo.'
  ...
  static String view(AppLanguage lang) =>
      lang == AppLanguage.filipino ? 'Tingnan' : 'View';
  ...
  static String wordCountLabel(AppLanguage lang) =>
      lang == AppLanguage.filipino ? 'salita' : 'words';
  ...
  static String categoriesUsedInfoBody(AppLanguage lang) =>
      lang == AppLanguage.filipino
      ? 'Ipinapakita ang mga kategoryang ginamit sa napiling panahon. '
            'Ang laki ng slice ay base sa kabuuang pagpindot, at ang bilang sa ilalim ng pangalan ay kung ilang salita ang napindot. '
            'Pindutin ang slice para makita sa gitna ang bilang ng salita nito.'
      : 'Shows the categories used for the selected period. '
            'Slice size is based on total taps, and the number under each name is how many words were tapped. '
            'Tap a slice to see its word count in the middle.';
  ...
  static String categoryLegendDetail({
    ...
    return vocabularyWords(wordCount, lang);
  }
  ...
  static String noNewPhrasesForPeriod(AppLanguage lang, String periodLabel) =>
      lang == AppLanguage.filipino
      ? 'Walang bagong pariralang naidagdag para sa $periodLabel.'
      : 'No new phrases added for $periodLabel.';
